...
public class MaxSumContiguousSubArray {
    public static void main(String[] args) {
        ...
        System.out.println("max sum of contiguous sub-array = " + maxSubArraySum(array, array.length));
        ...
        System.out.println("max sum of contiguous sub-array = " + maxSubArraySum(array1, array1.length));
        ...
        System.out.println("max sum of contiguous sub-array = " + maxSubArraySum(array2, array2.length));
        ...
        System.out.println("max sum of contiguous sub-array = " + maxSubArraySum(array3, array3.length));
