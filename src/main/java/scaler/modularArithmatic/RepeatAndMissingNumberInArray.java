...
public class RepeatAndMissingNumberInArray {
    ...
    private static int[] solve(final int[] A) {
        ...
        long sum1ToN = (((long) A.length * (A.length + 1)) / 2);

        long diff = Math.abs(sum - sum1ToN);
